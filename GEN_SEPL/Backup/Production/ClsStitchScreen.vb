...
#End Region
    ...
    Sub CreateForm(ByVal FormUID As String)
        Try
            oUtilities.SAPXML("GEN_STH_DESCR.xml")
            objForm = oApplication.Forms.GetForm("GEN_STH_DESCR", oApplication.Forms.ActiveForm.TypeCount)
            oDBs_Head = objForm.DataSources.DBDataSources.Item("@GEN_STH_DESCR")
            oDBs_Detail = objForm.DataSources.DBDataSources.Item("@GEN_STH_DESCR_D0")
    ...
    Sub SetDefault(ByVal FormUID As String)
        Try
            ...
            oDBs_Head = objForm.DataSources.DBDataSources.Item("@GEN_STH_DESCR")
            oDBs_Detail = objForm.DataSources.DBDataSources.Item("@GEN_STH_DESCR_D0")
            oUtilities.GetSeries(FormUID, "series", "GEN_STH_DESCR")
            oDBs_Head.SetValue("DocNum", 0, objForm.BusinessObject.GetNextSerialNumber(objForm.Items.Item("series").Specific.Selected.Value, "GEN_STH_DESCR"))
    ...
    Sub SetNewLine(ByVal FormUID As String, ByVal Row As Integer, ByRef oMatrix As SAPbouiCOM.Matrix)
        Try
            ...
            oDBs_Detail.SetValue("u_linename", oDBs_Detail.Offset, "")
    ...
    Sub FilterProductionOrders(ByVal FormUID As String)
        Try
            ...
            oRecordSet.DoQuery("Select Distinct A.DocNum From OWOR A Where A.ItemCode = '" + Trim(objForm.Items.Item("itemcode").Specific.value) + "' And A.u_process = 'Stitching'")
    ...
    Function Validation(ByVal FormUID As String) As Boolean
        Try
            ...
            If Trim(oDBs_Head.GetValue("u_prodno", 0)) = "" Then
                ...
                Return False
            End If
            oRSet.DoQuery("Select Code From [@GEN_STH_DESCR] Where u_itemcode = '" + Trim(objForm.Items.Item("itemcode").Specific.value) + "' And u_prodno = '" + Trim(objForm.Items.Item("prodno").Specific.value) + "' And DocNum <> '" + Trim(objForm.Items.Item("docnum").Specific.value) + "'")
            If oRSet.RecordCount > 0 Then
                oApplication.StatusBar.SetText("Stitching already defined for this production order", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                Return False
            End If
            Return True
        Catch ex As Exception
                        ...
                        If Not (oDT Is Nothing) And pVal.FormMode <> SAPbouiCOM.BoFormMode.fm_FIND_MODE Then
                            ...
                            If oCFL.UniqueID = "STPRCFL" Then
                                ...
                                For i As Integer = 0 To oDT.Rows.Count - 1
                                    ...
                                    oDBs_Detail.SetValue("u_line", oDBs_Detail.Offset, objMatrix.Columns.Item("line").Cells.Item(pVal.Row).Specific.value)
                                    oDBs_Detail.SetValue("u_linename", oDBs_Detail.Offset, objMatrix.Columns.Item("linename").Cells.Item(pVal.Row).Specific.value)
                            ...
                            If oCFL.UniqueID = "LNCFL" Then
                                ...
                                For i As Integer = 0 To oDT.Rows.Count - 1
                                    ...
                                    oDBs_Detail.Offset = pVal.Row - 1 + i
                                    oDBs_Detail.SetValue("LineID", oDBs_Detail.Offset, i + pVal.Row)
                                    oDBs_Detail.SetValue("u_prcs", oDBs_Detail.Offset, objMatrix.Columns.Item("prcs").Cells.Item(pVal.Row).Specific.value)
                                    oDBs_Detail.SetValue("u_prcsname", oDBs_Detail.Offset, objMatrix.Columns.Item("prcsname").Cells.Item(pVal.Row).Specific.value)
                                    oDBs_Detail.SetValue("u_line", oDBs_Detail.Offset, oDT.GetValue("Code", i))
                                    oDBs_Detail.SetValue("u_linename", oDBs_Detail.Offset, oDT.GetValue("Name", i))
                                    objMatrix.SetLineData(pVal.Row + i)
                                    objForm.EnableMenu("1293", True)
                                Next
                            End If
        ...
        Try
            If pVal.BeforeAction = False Then
                ...
                Select Case pVal.MenuUID
                    ...
                    Case "1282"
                        If objForm.TypeEx = "GEN_STH_DESCR" Then
                            Me.SetDefault(objForm.UniqueID)
                        End If
                    Case "1281"
                        If objForm.TypeEx = "GEN_STH_DESCR" Then
                        ...
                        If objForm.TypeEx = "GEN_STH_DESCR" Then
                            If ITEM_ID.Equals("mtx") = True Then
                                ...
                                For Row As Integer = 1 To objMatrix.VisualRowCount
                                    ...
                                    oDBs_Detail.SetValue("u_line", oDBs_Detail.Offset, objMatrix.Columns.Item("line").Cells.Item(Row).Specific.value)
                                    oDBs_Detail.SetValue("u_linename", oDBs_Detail.Offset, objMatrix.Columns.Item("linename").Cells.Item(Row).Specific.value)
