                ...
                Select Case pVal.MenuUID
                    ...
                    Case "1282"
                        ...
                        If objForm.TypeEx = "GEN_FRM_APP_ACC" Then
                            ...
                            objForm.Items.Item("ETDOCNUM").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 2, SAPbouiCOM.BoModeVisualBehavior.mvb_True)
        ...
        Try
            Select Case pVal.EventType
                ...
                Case SAPbouiCOM.BoEventTypes.et_DOUBLE_CLICK
                    If pVal.ItemUID = "38" And pVal.ColUID = "CLSELECT" Then
                        ...
                        For li_row As Integer = 0 To oDBs_Detail.Size - 1
                            If oDBs_Detail.Size >= li_row + 1 Then
                                ...
                                If Trim(oDBs_Detail.GetValue("U_SELECT", oDBs_Detail.Offset)) <> "Y" Then
                                    oDBs_Detail.SetValue("U_SELECT", li_row, "Y")
                                    li_row = li_row - 1
                                End If
                ...
                Case SAPbouiCOM.BoEventTypes.et_ITEM_PRESSED
                    If pVal.ItemUID = "27" And pVal.BeforeAction = False And (pVal.FormMode = SAPbouiCOM.BoFormMode.fm_ADD_MODE Or pVal.FormMode = SAPbouiCOM.BoFormMode.fm_UPDATE_MODE) Then
                        oDBs_Head = objForm.DataSources.DBDataSources.Item("@GEN_APP_ACC")
                        oDBs_Detail = objForm.DataSources.DBDataSources.Item("@GEN_APP_ACC_D0")
                        Dim oMatrix As SAPbouiCOM.Matrix
                        oMatrix = objForm.Items.Item("MTDTL").Specific
                        For i As Integer = 1 To oMatrix.RowCount
                            'oDBs_Detail.SetValue("U_SELECT", i - 1, "Y")
                            Dim Ocheck As SAPbouiCOM.CheckBox = oMatrix.Columns.Item("CLSELECT").Cells.Item(i).Specific
                            Ocheck.Checked = True
                        Next
                    End If
                    ...
                    ElseIf pVal.ItemUID = "BTGEN" And pVal.BeforeAction = True And (pVal.FormMode = SAPbouiCOM.BoFormMode.fm_OK_MODE) Then
                        ...
                        For li_row As Integer = 0 To oDBs_Detail.Size - 1
                            oDBs_Detail.Offset = li_row
                            Dim ss As String = oDBs_Detail.GetValue("U_DOC_TYPE", oDBs_Detail.Offset).ToString()
                            If Trim(oDBs_Detail.GetValue("U_DOC_TYPE", oDBs_Detail.Offset)) = "Invoice" Or Trim(oDBs_Detail.GetValue("U_DOC_TYPE", oDBs_Detail.Offset)) = "Item" Then
                    ...
                    ElseIf pVal.ItemUID = "BTFETCH" And pVal.BeforeAction = True Then
                        ...
                        ls_Query = "select case when N.Doctype='I' then 'Item'else 'Service' end as DocType,N.DocNum,N.DocEntry,convert(Char(10),N.DocDate,112) as DocDate,N.U_unit,N.Series " & _
                                    ...
                                    " And N.DocDate <= '" + oDBs_Head.GetValue("U_DATE_TO", 0) + "' And N.DocType in('I','S')"
