...
Public Class GEN_SEPL_SC_PO
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GEN_SEPL.GEN_SEPL_SC_PO.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGEN_SEPL_SC_PO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GEN_SEPL_SC_PO = New GEN_SEPL_SC_PO()
        rpt.Site = Me.Site
        Return rpt
    End Function
