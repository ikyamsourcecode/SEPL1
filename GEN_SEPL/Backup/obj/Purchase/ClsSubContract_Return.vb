        ...
        Try
            Select Case pVal.EventType
                ...
                Case SAPbouiCOM.BoEventTypes.et_ITEM_PRESSED
                    ...
                    End If
                    If pVal.ItemUID = "47" And pVal.BeforeAction = False And (pVal.FormMode = SAPbouiCOM.BoFormMode.fm_OK_MODE Or pVal.FormMode = SAPbouiCOM.BoFormMode.fm_VIEW_MODE) Then
                    ...
                    Case "Close"
                        If objForm.TypeEx = "GEN_SCRET" Then
                            If oApplication.MessageBox("Do you want to close?", 2, "Ok", "Cancel") = 1 Then
                                ...
                                If oDBs_Head.GetValue("U_InvTrDNo", 0).ToString().Trim() <> "" Then
