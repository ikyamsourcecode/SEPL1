            ...
            Select Case pVal.EventType
                ...
                Case SAPbouiCOM.BoEventTypes.et_ITEM_PRESSED
                    If pVal.ItemUID = "1" And pVal.BeforeAction = True And (pVal.FormMode = SAPbouiCOM.BoFormMode.fm_ADD_MODE Or pVal.FormMode = SAPbouiCOM.BoFormMode.fm_UPDATE_MODE) Then
                        '---> Vijeesh
                        'Me.Refresh_RawMaterial(FormUID)    'for itemqty editing changed on 19022016
                ...
                Case SAPbouiCOM.BoEventTypes.et_CHOOSE_FROM_LIST
                    ...
                    If Not (oDT Is Nothing) And pVal.FormMode <> SAPbouiCOM.BoFormMode.fm_FIND_MODE And pVal.BeforeAction = False Then
                        ...
                        ElseIf oCFL.UniqueID = "ITEM_CFL" Then
                            ...
                            ''Dim Query As String = "select b.ItemCode,b.ItemDesc,sum(b.Quantity) as Quantity,b.UoM,sum(b.POQty) as POQty,(sum(b.Price)/2)-9.4 as Price,sum(b.TotalLC) as TotalLC,b.TaxRate,b.TaxAmount,b.TaxCode,b.WhsCode,b.Remarks from(select b.LineID,b.U_ItemCode as ItemCode,b.U_ItemDesc as  ItemDesc,ISNULL(b.U_Quantity,0)-ISNULL(b.U_GRNQty,0) as Quantity,b.U_UOM UoM,b.U_Quantity POQty,b.U_Price as Price,b.U_TotalLC  as TotalLC,b.U_TaxRate  as TaxRate,b.U_TaxAmt as TaxAmount,b.U_TaxCode as TaxCode,b.U_Whs as WhsCode,b.U_Remarks as Remarks from [@GEN_SUB_CONTRACT] a join  [@GEN_SUB_CONTRACT_D0] b on a.docentry=b.docentry   where a.DocEntry='5835' and b.U_ItemCode='L134SN100206' and (ISNULL(b.U_Quantity,0)-ISNULL(b.U_GRNQty,0))>0)b group by b.ItemCode,b.ItemDesc,b.UoM,b.TaxRate,b.TaxAmount,b.TaxCode,b.WhsCode,b.Remarks"
    ...
    Function PostGoodsReceipt(ByVal FormUID As String) As Integer
        Try
            ...
            For i As Integer = 1 To objMartixFG.VisualRowCount - 1
                If i > 1 And Trim(objMartixFG.Columns.Item("ItemCode").Cells.Item(i).Specific.Value) <> "" Then oReceipt.Lines.Add()
