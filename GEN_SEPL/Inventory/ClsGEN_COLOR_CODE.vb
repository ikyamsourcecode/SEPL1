Public Class ClsGEN_COLOR_CODE
...
#End Region
    ...
    Sub CreateForm()
        Try
            oUtilities.SAPXML("GEN_COLOR_CODE.xml")
            objForm = oApplication.Forms.GetForm("GEN_COLOR_CODE", oApplication.Forms.ActiveForm.TypeCount)
            oDBs_Head = objForm.DataSources.DBDataSources.Item("@GEN_COLOR_CODE")
    ...
    Sub SetDefault(ByVal FormUID As String)
        Try
            ...
            oRSet.DoQuery("Select IsNull(Max(Code),0) + 1 'Count' From [@GEN_COLOR_CODE]")
    ...
    Function Validation(ByVal FormUID As String) As Boolean
        Try
            ...
            If Trim(objForm.Items.Item("name").Specific.Value) = "" Then
                oApplication.StatusBar.SetText("Please enter Color Code", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                Return False
                Exit Function
            End If
            ...
            oRecordSet.DoQuery("Select Name From [@GEN_COLOR_CODE] Where Name = '" + Trim(objForm.Items.Item("name").Specific.Value) + "' And Code <> '" + Trim(objForm.Items.Item("code").Specific.Value) + "' And u_type = '" + Trim(objForm.Items.Item("type").Specific.value) + "'")
            ...
            End If
            Dim oRSet As SAPbobsCOM.Recordset = oCompany.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset)
            oRSet.DoQuery("Select IsNull(Max(Convert(Int,Code)),0) + 1 'Count' From [@GEN_COLOR_CODE]")
            ...
            If pVal.BeforeAction = False Then
                ...
                Select Case pVal.MenuUID
                    Case "GEN_COLOR_CODE"
                        Me.CreateForm()
                    Case "1282"
                        If oForm.TypeEx = "GEN_COLOR_CODE" Then
