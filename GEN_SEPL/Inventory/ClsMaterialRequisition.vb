...
#End Region
    ...
    Sub SetDefault(ByVal FormUID As String)
        Try
            ...
            oDBs_Head.SetValue("U_mstatus", 0, "Open")
    ...
    Function Validation(ByVal FormUID As String) As Boolean
        Try
            ...
            If Trim(oDBs_Head.GetValue("u_type", 0)) = "Regular" Or Trim(oDBs_Head.GetValue("u_type", 0)) = "Excess" Or Trim(oDBs_Head.GetValue("u_type", 0)) = "Production Consumable" Then
                ...
                ''            '  If CDbl(objMatrix.Columns.Item("totis").Cells.Item(i).Specific.Value) = "0.00" Then
                ''            Dim oRS1 As SAPbobsCOM.Recordset = oCompany.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset)
                ''            oRS1.DoQuery("select sum(M1.u_rqstqty) from [@GEN_MREQ] M  inner join [@GEN_MREQ_D0] M1 on M.DocEntry = M1.DocEntry where (M.U_type='Regular' or M.U_type='Production Consumable') and M.u_sono='" + (objForm.Items.Item("sono").Specific.Value) + "' and M.U_itemcode='" + (objForm.Items.Item("itemcode").Specific.Value) + "' and M.U_sfgcode='" + (objForm.Items.Item("sfgcode").Specific.Value) + "' AND M1.U_whs='" + (objMatrix.Columns.Item("whs").Cells.Item(i).Specific.value) + "'AND M1.U_Itemcode='" + (objMatrix.Columns.Item("itemcode").Cells.Item(i).Specific.value) + "'")
                ''            Dim oRS3 As SAPbobsCOM.Recordset = oCompany.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset)
                ''            oRS3.DoQuery("select B1.Code,(B1.Quantity) from OITT B inner join ITT1 B1 on B.Code = B1.Father where B.Code='" + (objForm.Items.Item("sfgcode").Specific.Value) + "' and B1.Code='" + (objMatrix.Columns.Item("itemcode").Cells.Item(i).Specific.value) + "'")
                ''            If (CDbl(objMatrix.Columns.Item("rqstqty").Cells.Item(i).Specific.Value) + (oRS1.Fields.Item(0).Value)) > (CDbl(objForm.Items.Item("ordrqty").Specific.Value) * oRS3.Fields.Item(1).Value) Then
                ...
                ''            'oRS2.DoQuery("select B1.Code,(B1.Quantity) from OITT B inner join ITT1 B1 on B.Code = B1.Father where B.Code='" + (objForm.Items.Item("sfgcode").Specific.Value) + "' and B1.Code='" + (objMatrix.Columns.Item("itemcode").Cells.Item(i).Specific.value) + "'")
                ''            'If (CDbl(objMatrix.Columns.Item("rqstqty").Cells.Item(i).Specific.Value) + CDbl(objMatrix.Columns.Item("totis").Cells.Item(i).Specific.Value)) > (CDbl(objForm.Items.Item("ordrqty").Specific.Value) * oRS2.Fields.Item(1).Value) Then
                ''            '    oApplication.StatusBar.SetText(" " + Trim(oDBs_Head.GetValue("u_type", 0)) + " MRN Cannot be Generated for Item Code --> " + Trim(objMatrix.Columns.Item("itemcode").Cells.Item(i).Specific.value) + " ", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                ''            '    Return False
                ''            '    Exit Function
                ''            'End If
    ...
    Function Validation1(ByVal FormUID As String) As Boolean
        Try
            Dim WhsFlag As Boolean = False
            Dim RowWhs As String
            Dim oRSet As SAPbobsCOM.Recordset = oCompany.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset)
                ...
                For i As Integer = 1 To objMatrix.VisualRowCount
                    If Trim(oDBs_Head.GetValue("u_type", 0)) = "Regular" Then
                        If Trim(objMatrix.Columns.Item("itemcode").Cells.Item(i).Specific.value) <> "" And Trim(objForm.Items.Item("status").Specific.Selected.Value) <> "Closed" Then
                            ...
                            '  If CDbl(objMatrix.Columns.Item("totis").Cells.Item(i).Specific.Value) = "0.00" Then
                            Dim oRS1 As SAPbobsCOM.Recordset = oCompany.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset)
                            oRS1.DoQuery("select sum(M1.u_rqstqty) from [@GEN_MREQ] M  inner join [@GEN_MREQ_D0] M1 on M.DocEntry = M1.DocEntry where (M.U_type='Regular') and M.u_sono='" + (objForm.Items.Item("sono").Specific.Value) + "' and M.U_itemcode='" + (objForm.Items.Item("itemcode").Specific.Value) + "' and M.U_mstatus='OPEN' and M.U_sfgcode='" + (objForm.Items.Item("sfgcode").Specific.Value) + "' AND M1.U_whs='" + (objMatrix.Columns.Item("whs").Cells.Item(i).Specific.value) + "'AND M1.U_Itemcode='" + (objMatrix.Columns.Item("itemcode").Cells.Item(i).Specific.value) + "'")
                            Dim oRS3 As SAPbobsCOM.Recordset = oCompany.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset)
                            oRS3.DoQuery("select B1.Code,(B1.Quantity) from OITT B inner join ITT1 B1 on B.Code = B1.Father where B.Code='" + (objForm.Items.Item("sfgcode").Specific.Value) + "' and B1.Code='" + (objMatrix.Columns.Item("itemcode").Cells.Item(i).Specific.value) + "'")
                            If (CDbl(objMatrix.Columns.Item("rqstqty").Cells.Item(i).Specific.Value) + (oRS1.Fields.Item(0).Value)) > (CDbl((objForm.Items.Item("ordrqty").Specific.Value) * oRS3.Fields.Item(1).Value) + 1) Then
                                oApplication.StatusBar.SetText(" " + Trim(oDBs_Head.GetValue("u_type", 0)) + " MRN Cannot be Generated for Item Code --> " + Trim(objMatrix.Columns.Item("itemcode").Cells.Item(i).Specific.value) + " ", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                                Return False
                                Exit Function
                            End If
                    ...
                    If Trim(oDBs_Head.GetValue("u_type", 0)) = "Production Consumable" Then
                        If Trim(objMatrix.Columns.Item("itemcode").Cells.Item(i).Specific.value) <> "" And Trim(objForm.Items.Item("status").Specific.Selected.Value) <> "Closed" Then
                            Dim oRS As SAPbobsCOM.Recordset = oCompany.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset)
                            oRS.DoQuery("Select Distinct B.u_qty From [@GEN_CUST_BOM] A INNER JOIN [@GEN_CUST_BOM_D0] B ON A.DOCENTRY = B.DOCENTRY Where B.u_itemcode = '" + Trim(objMatrix.Columns.Item("itemcode").Cells.Item(i).Specific.value) + "' And A.u_itemcode = '" + Trim(objForm.Items.Item("itemcode").Specific.value) + "' And A.u_sono = '" + Trim(objForm.Items.Item("sono").Specific.value) + "'")
                            'If (CDbl(objMatrix.Columns.Item("rqstqty").Cells.Item(i).Specific.Value) + CDbl(objMatrix.Columns.Item("totis").Cells.Item(i).Specific.Value)) > CDbl(objMatrix.Columns.Item("reqdqty").Cells.Item(i).Specific.Value) + ((CDbl(objMatrix.Columns.Item("reqdqty").Cells.Item(i).Specific.Value) * CDbl(oRS.Fields.Item("u_per").Value)) / 100) Then
                            '  If CDbl(objMatrix.Columns.Item("totis").Cells.Item(i).Specific.Value) = "0.00" Then
                            Dim oRS1 As SAPbobsCOM.Recordset = oCompany.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset)
                            oRS1.DoQuery("select sum(M1.u_rqstqty) from [@GEN_MREQ] M  inner join [@GEN_MREQ_D0] M1 on M.DocEntry = M1.DocEntry where (M.U_type='Production Consumable') and M.u_sono='" + (objForm.Items.Item("sono").Specific.Value) + "' and M.U_itemcode='" + (objForm.Items.Item("itemcode").Specific.Value) + "' and M.U_mstatus='OPEN' AND M1.U_whs='" + (objMatrix.Columns.Item("whs").Cells.Item(i).Specific.value) + "'AND M1.U_Itemcode='" + (objMatrix.Columns.Item("itemcode").Cells.Item(i).Specific.value) + "'")
                            Dim oRS3 As SAPbobsCOM.Recordset = oCompany.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset)
                            oRS3.DoQuery("select B1.Code,(B1.Quantity) from OITT B inner join ITT1 B1 on B.Code = B1.Father where B.Code='" + (objForm.Items.Item("sfgcode").Specific.Value) + "' and B1.Code='" + (objMatrix.Columns.Item("itemcode").Cells.Item(i).Specific.value) + "'")
                            If (CDbl(objMatrix.Columns.Item("rqstqty").Cells.Item(i).Specific.Value) + (oRS1.Fields.Item(0).Value)) > (CDbl((objForm.Items.Item("ordrqty").Specific.Value) * oRS.Fields.Item(0).Value) + 1) Then
                                oApplication.StatusBar.SetText(" " + Trim(oDBs_Head.GetValue("u_type", 0)) + " MRN Cannot be Generated for Item Code --> " + Trim(objMatrix.Columns.Item("itemcode").Cells.Item(i).Specific.value) + " ", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                                Return False
                                Exit Function
                            End If
            ...
            Select Case pVal.EventType
                ...
                Case SAPbouiCOM.BoEventTypes.et_ITEM_PRESSED
                    ...
                    If pVal.ItemUID = "btnis" And pVal.BeforeAction = False And pVal.FormMode = SAPbouiCOM.BoFormMode.fm_OK_MODE Then
                        ...
                        _str_Type = Trim(objForm.Items.Item("type").Specific.value)
                                        ...
                                        For i As Integer = 1 To oRecordSet.RecordCount
                                            Try
                                                ...
                                                ElseIf oRSUnit.Fields.Item("unit").Value = "UNIT2" Then
                                                    ...
                                                    End If
                                                ElseIf oRSUnit.Fields.Item("unit").Value = "LG-UNIT1" Then
                                                    If _str_Type = "Sampling" Then
                                                        GIMatrix.Columns.Item("57").Cells.Item(i).Specific.Value = "400024-11"
                                                    Else
                                                        GIMatrix.Columns.Item("57").Cells.Item(i).Specific.Value = "400023-11"
                                                    End If
                                                Else
