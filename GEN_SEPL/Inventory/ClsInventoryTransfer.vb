...
#End Region
    ...
    Sub FilterNonTrWhse(ByVal FormUID As String)
        Try
            ...
            Dim oCons As SAPbouiCOM.Conditions
            Dim oCon As SAPbouiCOM.Condition
            Dim oCFL As SAPbouiCOM.ChooseFromList = objForm.ChooseFromLists.Item("5")
            oCFL.SetConditions(emptyConds)
            oCons = oCFL.GetConditions()
    ...
    Sub FilterNonTrWhse1(ByVal FormUID As String)
        Try
            objForm = oApplication.Forms.Item(FormUID)
            ...
            Dim oCons As SAPbouiCOM.Conditions
            Dim oCon As SAPbouiCOM.Condition
            Dim oCFL As SAPbouiCOM.ChooseFromList = objForm.ChooseFromLists.Item("4")
            oCFL.SetConditions(emptyConds)
            oCons = oCFL.GetConditions()
        ...
        Try
            Select Case pVal.EventType
                ...
                Case SAPbouiCOM.BoEventTypes.et_KEY_DOWN
                    oDBs_Head = objForm.DataSources.DBDataSources.Item("OWTR")
                    Dim strfwhs As String = oDBs_Head.GetValue("U_Type", 0).ToString().Trim()

                    If (pVal.ItemUID = "18" Or pVal.ItemUID = "1470000101") And pVal.BeforeAction = True And (strfwhs = "Transit") Then
                        If KeyStat = "" Then
                            BubbleEvent = False
                            oApplication.StatusBar.SetText("Your not Authorized to Change....", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error)

                        End If


                    End If
                    If pVal.ItemUID = "23" And pVal.ColUID <> "10" And (strfwhs = "Transit") Then
                ...
                Case SAPbouiCOM.BoEventTypes.et_ITEM_PRESSED
                    If pVal.ItemUID = "1" And pVal.BeforeAction = True And pVal.FormMode = SAPbouiCOM.BoFormMode.fm_ADD_MODE Then
                        ...
                        Dim Towhs As String = objForm.Items.Item("1470000101").Specific.value
                        If Towhs = "INSP-2" Then
                            oApplication.StatusBar.SetText("Your not Authorized to move Items to '" + Towhs + "'", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                            BubbleEvent = False
                        ...
                        For i As Integer = 1 To oMatrix1.VisualRowCount - 1
                            If oMatrix1.Columns.Item("5").Cells.Item(i).Specific.Value = "INSP-2" Then
                                oApplication.StatusBar.SetText("Your not Authorized to move Items to INSP-2", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                                BubbleEvent = False
                                Exit Sub
                            End If
                        Next
                        If Trim(objForm.Items.Item("grnno").Specific.value) <> "" Then
                            ...
                            For i As Integer = 1 To oMatrix.VisualRowCount - 1
                                If oMatrix.Columns.Item("U_grpostat").Cells.Item(i).Specific.selected Is Nothing = True Then
                                    ...
                                    Exit Sub
                                End If
                                'If oMatrix.Columns.Item("5").Cells.Item(i).Specific.Value = Towhs.Trim() Then
                                '    oApplication.StatusBar.SetText("Your not Authorized to move Items to '" + Towhs + "'", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                                '    BubbleEvent = False
                                '    Exit Sub
                                'End If
                        ...
                        If Trim(objForm.Items.Item("mrnno").Specific.value) <> "" Then
                            ...
                            ElseIf objForm.Items.Item("isstyp").Specific.value = "R" Then
                                ...
                                For i As Integer = 1 To oMatrix.VisualRowCount - 1
                                    If oMatrix.Columns.Item("1").Cells.Item(i).Specific.value <> "" Then
                                        Dim a1 As String = oMatrix.Columns.Item("10").Cells.Item(i).Specific.value
                                        Dim a2 As String = oMatrix.Columns.Item("U_issued").Cells.Item(i).Specific.value
                                        If Convert.ToDouble(a1) > Convert.ToDouble(a2) Then
                        ...
                        End If
                        'Vijeesh
                        Dim oMatrix11 As SAPbouiCOM.Matrix
                        oMatrix11 = objForm.Items.Item("23").Specific
                        For i As Integer = 1 To oMatrix11.VisualRowCount
                            Dim oRs As SAPbobsCOM.Recordset = oCompany.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset)
                            oRs.DoQuery("Select u_intwhs from owhs where whscode='" + oMatrix11.Columns.Item("5").Cells.Item(i).Specific.value + "'")
                ...
                Case SAPbouiCOM.BoEventTypes.et_CHOOSE_FROM_LIST
                    ...
                    If pVal.BeforeAction = True Then
                        ...
                        oCFL1 = objForm.ChooseFromLists.Item(CFL_Id1)
                        Dim oDT1 As SAPbouiCOM.DataTable
                        oDT1 = CFLEvent1.SelectedObjects
                        If oCFL1.UniqueID = "5" And strfwhs = "" Then
                            FilterNonTrWhse(objForm.UniqueID)
                        End If
                        If oCFL1.UniqueID = "4" And strfwhs = "" Then
                            FilterNonTrWhse1(objForm.UniqueID)
                        End If
                    ...
                    If Not (oDT Is Nothing) And pVal.FormMode = SAPbouiCOM.BoFormMode.fm_ADD_MODE And pVal.BeforeAction = True Then
                        If oCFL.UniqueID = "5" Then
                    ...
                    If pVal.Before_Action = False And pVal.ItemUID = "U_DocNum" Then
                        ...
                        If Trans = False Then
                            If objForm.Items.Item("type").Specific.value = "Transit" Then
                                ...
                                Dim ors As SAPbobsCOM.Recordset = oCompany.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset)
                                ors.DoQuery("Select ItemCode,U_twhs,Quantity,WhsCode,Filler From OWTR A inner join WTR1 B on A.DocEntry = B.DocEntry Where A.DocNum = '" + objform1.Items.Item("U_DocNum").Specific.Value + "'")
                                objForm.Items.Item("18").Specific.value = ors.Fields.Item(3).Value
                                objForm.Items.Item("1470000101").Specific.value = ors.Fields.Item(1).Value
                                For i As Integer = 1 To ors.RecordCount
                                    ...
                                    ' oMatrix1.Columns.Item("5").Cells.Item(i).Specific.Value = ors.Fields.Item(4).Value
