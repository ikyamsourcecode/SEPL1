Public Class ClsGEN_STYLE_CODE
...
#End Region
    ...
    Sub CreateForm()
        Try
            oUtilities.SAPXML("GEN_STYLE_CODE.xml")
            objForm = oApplication.Forms.GetForm("GEN_STYLE_CODE", oApplication.Forms.ActiveForm.TypeCount)
            oDBs_Head = objForm.DataSources.DBDataSources.Item("@GEN_STYLE_CODE")
    ...
    Sub SetDefault(ByVal FormUID As String)
        Try
            ...
            oRSet.DoQuery("Select IsNull(Max(Code),0) + 1 'Count' From [@GEN_STYLE_CODE]")
    ...
    Function Validation(ByVal FormUID As String) As Boolean
        Try
            ...
            oRecordSet.DoQuery("Select Name From [@GEN_STYLE_CODE] Where Name = '" + Trim(objForm.Items.Item("name").Specific.Value) + "' And Code <> '" + Trim(objForm.Items.Item("code").Specific.Value) + "' And u_type = '" + Trim(objForm.Items.Item("type").Specific.value) + "'")
            ...
            End If
            Dim oRSet As SAPbobsCOM.Recordset = oCompany.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset)
            oRSet.DoQuery("Select IsNull(Max(Convert(Int,Code)),0) + 1 'Count' From [@GEN_STYLE_CODE]")
            ...
            If pVal.BeforeAction = False Then
                ...
                Select Case pVal.MenuUID
                    Case "GEN_STYLE_CODE"
                        Me.CreateForm()
                    Case "1282"
                        If oForm.TypeEx = "GEN_STYLE_CODE" Then
