...
#Region "       -- UDF --          "
    ...
    Sub Pre_Shipment()
        ...
        Me.AddColumns("@PRE_SHIPMENT_D0", "Discount", "Discount", SAPbobsCOM.BoFieldTypes.db_Float, 0, SAPbobsCOM.BoFldSubTypes.st_Price)
    ...
    End Sub
    Sub EcgcMaster()
        Me.AddTable("GEN_ECGC", "Ecgc Master", SAPbobsCOM.BoUTBTableType.bott_MasterData)
        Me.AddTable("GEN_ECGC_D0", "Ecgc Master Lines", SAPbobsCOM.BoUTBTableType.bott_MasterDataLines)

        Me.AddColumns("@GEN_ECGC", "cardcode", "Customer Code", SAPbobsCOM.BoFieldTypes.db_Alpha, 30)
        Me.AddColumns("@GEN_ECGC", "cardname", "Customer Name", SAPbobsCOM.BoFieldTypes.db_Alpha, 100)
        Me.AddColumns("@GEN_ECGC", "Unit", "Unit", SAPbobsCOM.BoFieldTypes.db_Alpha, 30)
        Me.AddColumns("@GEN_ECGC", "Ecgc", "Ecgc Limit", SAPbobsCOM.BoFieldTypes.db_Float, 10, SAPbobsCOM.BoFldSubTypes.st_Price)

        Me.AddColumns("@GEN_ECGC_D0", "cardcode", "Customer Code", SAPbobsCOM.BoFieldTypes.db_Alpha, 30)
        Me.AddColumns("@GEN_ECGC_D0", "cardname", "Customer Name", SAPbobsCOM.BoFieldTypes.db_Alpha, 100)
        Me.AddColumns("@GEN_ECGC_D0", "Unit", "Unit", SAPbobsCOM.BoFieldTypes.db_Alpha, 30)
       
        If Not Me.UDOExists("GEN_ECGC") Then
            Dim findAliasNDescription As String(,) = {{"Code", "Code"}}
            Me.registerUDO("GEN_ECGC", "GEN_ECGC", SAPbobsCOM.BoUDOObjType.boud_MasterData, findAliasNDescription, "GEN_ECGC", "GEN_ECGC_D0", "", "", SAPbobsCOM.BoYesNoEnum.tNO, SAPbobsCOM.BoYesNoEnum.tNO)
            findAliasNDescription = Nothing
        End If
    End Sub
    Sub SAP_TABLES_UDF()
        Try
            ...
            Me.AddColumns("ODLN", "tinv", "Type Of Invoice", SAPbobsCOM.BoFieldTypes.db_Alpha, 100)
            ...
            Dim ValidValues12 = New String(,) {{"YES", "YES"}, {"NO", "NO"}}
            Dim DefaultVal11 = New String(,) {{"YES", "YES"}}
            Me.AddColumns("OCRD", "Ecgc", "Ecgc Reuired ?", SAPbobsCOM.BoFieldTypes.db_Alpha, 5, SAPbobsCOM.BoFldSubTypes.st_None, "", Nothing, ValidValues12, 0, DefaultVal11)
    ...
    Sub SubContracting()
        Try
            ...
            Me.AddColumns("@GEN_SUB_CONTRACT", "Owhs", "Old WareHouse", SAPbobsCOM.BoFieldTypes.db_Alpha, 25)
            Me.AddColumns("@GEN_SUB_CONTRACT", "Nwhs", "New Warehouse", SAPbobsCOM.BoFieldTypes.db_Alpha, 25)
