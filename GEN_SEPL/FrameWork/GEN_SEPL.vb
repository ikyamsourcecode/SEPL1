...
#Region "Class Declaration"
    ...
    Dim objBP As New ClsBP
    Dim objProductionOrder As New ClsProductionOrder
    Dim objECGCMaster As New ClsEcgc
...
#End Region
        ...
        Try
            Select Case pVal.FormTypeEx
                ...
                Case "9999"
                    ...
                    objDelivery.ItemEvent_Pre(FormUID, pVal, BubbleEvent)
                Case "425"
                    'objARInvoice.ItemEvent_Pre(FormUID, pVal, BubbleEvent)
                    objDelivery.ItemEvent_Pre(FormUID, pVal, BubbleEvent)
                Case "GEN_SUPP_PRICE"
                ...
                Case "134"
                    objBP.ItemEvent(FormUID, pVal, BubbleEvent)
                Case "65211"
                    objProductionOrder.ItemEvent(FormUID, pVal, BubbleEvent)
                Case "GEN_ECGC"
                    objECGCMaster.ItemEvent(FormUID, pVal, BubbleEvent)
            End Select
    ...
    Private Sub oApplication_MenuEvent(ByRef pVal As SAPbouiCOM.MenuEvent, ByRef BubbleEvent As Boolean) Handles oApplication.MenuEvent
        Try
            ...
            objECGCMaster.MenuEvent(pVal, BubbleEvent)
    ...
    Private Sub oApplication_RightClickEvent(ByRef eventInfo As SAPbouiCOM.ContextMenuInfo, ByRef BubbleEvent As Boolean) Handles oApplication.RightClickEvent
        Try
            ...
            Select Case oForm.TypeEx
                ...
                Case "GEN_ECGC"
                    objECGCMaster.RightClickEvent(eventInfo, BubbleEvent)
            End Select
        Catch ex As Exception
            oApplication.SetStatusBarMessage(ex.Message)
        End Try
