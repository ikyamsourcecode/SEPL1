...
Public Class SubContract_GRPO
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GEN_SEPL.SubContract_GRPO.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSubContract_GRPO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SubContract_GRPO = New SubContract_GRPO()
        rpt.Site = Me.Site
        Return rpt
    End Function
