...
#End Region
    ...
    Sub CreateForm(ByVal FormUID As String)
        Try
            oUtilities.SAPXML("GEN_MACH_POOL.xml")
            objForm = oApplication.Forms.GetForm("GEN_MACH_POOL", oApplication.Forms.ActiveForm.TypeCount)
            oDBs_Head = objForm.DataSources.DBDataSources.Item("@GEN_MACH_POOL")
            oDBs_Detail = objForm.DataSources.DBDataSources.Item("@GEN_MACH_POOL_D0")
    ...
    Sub SetNewLine(ByVal FormUID As String, ByVal Row As Integer, ByRef oMatrix As SAPbouiCOM.Matrix)
        Try
            ...
            oDBs_Detail.SetValue("u_type", oDBs_Detail.Offset, "")
            oDBs_Detail.SetValue("u_typename", oDBs_Detail.Offset, "")
    ...
    Function Validation(ByVal FormUID As String) As Boolean
        Try
            ...
            oRSet.DoQuery("Select Name From [@GEN_MACH_POOL] Where Name = '" + Trim(oDBs_Head.GetValue("Name", 0)) + "' And Code <> '" + Trim(objForm.Items.Item("code").Specific.value) + "'")
            ...
            Select Case pVal.EventType
                ...
                Case SAPbouiCOM.BoEventTypes.et_ITEM_PRESSED
                    ...
                    ElseIf pVal.ItemUID = "1" And pVal.ActionSuccess = True And pVal.FormMode = SAPbouiCOM.BoFormMode.fm_ADD_MODE Then
                        Dim oRSet As SAPbobsCOM.Recordset = oCompany.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset)
                        oRSet.DoQuery("Select Count(*) + 1 AS 'Count' From [@GEN_MACH_POOL]")
                        oDBs_Head = objForm.DataSources.DBDataSources.Item("@GEN_MACH_POOL")
                        ...
                        If Not (oDT Is Nothing) And pVal.FormMode <> SAPbouiCOM.BoFormMode.fm_FIND_MODE Then
                            ...
                            If oCFL.UniqueID = "LINECFL" Then
                                ...
                                For i As Integer = 0 To oDT.Rows.Count - 1
                                    ...
                                    oDBs_Detail.SetValue("u_line", oDBs_Detail.Offset, oDT.GetValue("Name", i))
                            ...
                            If oCFL.UniqueID = "LNTPCFL" Then
                                ...
                                For i As Integer = 0 To oDT.Rows.Count - 1
                                    ...
                                    oDBs_Detail.Offset = pVal.Row - 1 + i
                                    oDBs_Detail.SetValue("LineID", oDBs_Detail.Offset, i + pVal.Row)
                                    oDBs_Detail.SetValue("u_type", oDBs_Detail.Offset, oDT.GetValue("Code", i))
                                    oDBs_Detail.SetValue("u_typename", oDBs_Detail.Offset, oDT.GetValue("Name", i))
        ...
        Try
            If pVal.BeforeAction = False Then
                ...
                Select Case pVal.MenuUID
                    ...
                    Case "1282"
                        If objForm.TypeEx = "GEN_MACH_POOL" Then
                            Dim oRSet As SAPbobsCOM.Recordset = oCompany.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset)
                            oRSet.DoQuery("Select Count(*) + 1 AS 'Count' From [@GEN_MACH_POOL]")
                            oDBs_Head = objForm.DataSources.DBDataSources.Item("@GEN_MACH_POOL")
                            oDBs_Head.SetValue("Code", 0, oRSet.Fields.Item("Count").Value)
                        ...
                        If objForm.TypeEx = "GEN_MACH_POOL" Then
                            If ITEM_ID.Equals("mtx") = True Then
                                ...
                                For Row As Integer = 1 To objMatrix.VisualRowCount
                                    ...
                                    oDBs_Detail.SetValue("u_type", oDBs_Detail.Offset, objMatrix.Columns.Item("type").Cells.Item(Row).Specific.value)
                                    oDBs_Detail.SetValue("u_typename", oDBs_Detail.Offset, objMatrix.Columns.Item("typename").Cells.Item(Row).Specific.value)
