...
#End Region
    ...
    Sub CreateForm()
        Try
            oUtilities.SAPXML("GEN_ITM_TYPE.xml")
            objForm = oApplication.Forms.GetForm("GEN_ITM_TYPE", oApplication.Forms.ActiveForm.TypeCount)
            oDBs_Head = objForm.DataSources.DBDataSources.Item("@GEN_ITM_TYPE")
    ...
    Function Validation(ByVal FormUID As String) As Boolean
        Try
            ...
            oRecordSet.DoQuery("Select Code From [@GEN_ITM_TYPE] Where Code = '" + Trim(objForm.Items.Item("code").Specific.Value) + "' And Code <> '" + Trim(objForm.Items.Item("code").Specific.Value) + "'")
            ...
            If pVal.BeforeAction = False Then
                ...
                Select Case pVal.MenuUID
                    Case "GEN_ITM_TYPE"
                        Me.CreateForm()
                    Case "1282"
                        If oForm.TypeEx = "GEN_ITM_TYPE" Then
