...
#End Region
    ...
    Sub CreateForm(ByVal FormUID As String)
        Try
            ...
            oItem.Height = 14
            oItem.Specific.databind.setbound(True, "OIGE", "u_type")
            oItem.Visible = False
            oItem.LinkTo = "16"
            ...
            oItem.Left = oTempItem.Left
            oItem.Height = 14
            oItem.Specific.databind.setbound(True, "OIGE", "u_mrnno")
            oItem.Visible = False
            oItem.LinkTo = "16"
            ...
            oItem.Left = oTempItem.Left
            oItem.Height = 14
            oItem.Specific.databind.setbound(True, "OIGE", "u_subconno")
            oItem.Visible = False
            oItem.LinkTo = "16"
            ...
            oItem.Left = oTempItem.Left
            oItem.Height = 14
            oItem.Specific.databind.setbound(True, "OIGE", "u_isstyp")
            oItem.Visible = False
            oItem.LinkTo = "16"
            ...
            oItem.Left = oTempItem.Left
            oItem.Height = 14
            oItem.Specific.databind.setbound(True, "OIGE", "u_subretno")
            oItem.Visible = False
            oItem.LinkTo = "16"
            ...
            oItem.Left = oTempItem.Left
            oItem.Height = 14
            oItem.Specific.databind.setbound(True, "OIGE", "u_itemcode")
            oItem.Visible = False
            oItem.LinkTo = "16"
            ...
            oItem.Left = oTempItem.Left
            oItem.Height = 14
            oItem.Specific.databind.setbound(True, "OIGE", "u_sfgcode")
            oItem.Visible = False
            oItem.LinkTo = "16"
            ...
            oItem.Left = oTempItem.Left
            oItem.Height = 14
            oItem.Specific.databind.setbound(True, "OIGE", "u_grnno")
            oItem.Visible = False
            oItem.LinkTo = "16"
            ...
            oItem.Left = oTempItem.Left
            oItem.Height = 14
            oItem.Specific.databind.setbound(True, "OIGE", "u_DocNum")
            oItem.Visible = False
            oItem.LinkTo = "16"
                ...
                Case SAPbouiCOM.BoEventTypes.et_ITEM_PRESSED
                    ...
                    If pVal.ItemUID = "1" And pVal.BeforeAction = True And pVal.FormMode = SAPbouiCOM.BoFormMode.fm_ADD_MODE Then
                        If Trim(objForm.Items.Item("mrnno").Specific.value) <> "" Then
                            ...
                            oMatrix = objForm.Items.Item("13").Specific
                            For i As Integer = 1 To oMatrix.VisualRowCount - 1
                                If oMatrix.Columns.Item("1").Cells.Item(i).Specific.value <> "" Then
                                    If (oMatrix.Columns.Item("9").Cells.Item(i).Specific.value > (oMatrix.Columns.Item("U_rqstqty").Cells.Item(i).Specific.value - oMatrix.Columns.Item("U_issued").Cells.Item(i).Specific.value)) Then
